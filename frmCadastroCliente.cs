    ...
    public partial class frmCadastroCliente : Form
    {
       ...
       (
        ...
        private void btnCadastro_Click(object sender, EventArgs e)
        {
            ...
            if(txtNome.Text.Contains(" ") && txtNome.Text.Length > 8 && (txtEmail.Text.Contains("@gmail.com") || txtEmail.Text.Contains("@outlook.com") || txtEmail.Text.Contains("@hotmail.com")) && txtSenha.Text.Length >= 8)
            {
